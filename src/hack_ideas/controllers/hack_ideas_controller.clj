...
(defn get-hack-idea-handler [idea-id]
  (def view-model (helper/created-at-pretty-maker (idea/one idea-id)))
  (render-page (show-view/render view-model)) 
  )

(defn get-hack-ideas-handler []
  (def view-model (map helper/created-at-pretty-maker (idea/all)))
...
(defn create-hack-idea-handler [params]
  ...
  (def view-model (helper/created-at-pretty-maker created-idea))
  (render-page (show-view/render view-model))
  )
